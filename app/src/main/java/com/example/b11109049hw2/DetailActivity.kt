...
class DetailActivity : ComponentActivity() {
    ...
    fun getDescription(index: Int): String {
        return when (index) {
            0 -> "八卦山位於台灣台中市，是台灣最具代表性的山岳之一。它也是台灣的三大神山之一，象徵著台灣的文化信仰和山林景觀。八卦山的山勢起伏，山腰樹木蓊鬱，風景優美。山上有許多古老的寺廟和道觀，如日月潭文武廟、普濟寺等，吸引許多信徒和遊客前來朝拜和遊覽。登上八卦山可以俯瞰台中市區和周邊山脈，景色壯麗，是許多登山愛好者和觀光客喜愛的景點之一。\n" +
                    "\n" +
                    "\n" +
                    "\n" +
                    "\n" +
            ...
            1 -> "台中中央公園是位於台中市西屯區的一個大型綠地公園，面積約67公頃，是台灣中部地區的重要城市綠肺。公園設計融合了自然景觀與現代設施，內有廣闊的草坪、人工湖、步道、自行車道，以及多處運動設施，如籃球場和羽毛球場。中央公園不僅是市民休閒娛樂的好去處，也是舉辦各種戶外活動和文化活動的理想場所。公園內的生態保護區和水資源管理系統展示了環保與可持續發展的理念，是台中市推動綠色城市的重要象徵。\n" +
                    ...
                    "\n" +
                    "\n"
            2 -> "日月潭位於台灣中部的南投縣，是台灣最大的天然湖泊。湖泊形狀如同日月交輝，因此得名。日月潭被群山環繞，湖水清澈，景色宜人，是著名的旅遊勝地。日月潭不僅有豐富的自然美景，如涵碧樓、文武廟和慈恩塔，還有豐富的人文歷史背景，讓遊客能夠享受到自然與文化的雙重魅力。每年吸引眾多遊客前來觀光，並且是台灣重要的旅遊地標之一。\n" +
                    "\n" +
                    "\n" +
                    "\n" +
                    "\n" +
